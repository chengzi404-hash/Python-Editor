...
def text(content: str, status: int = 200, headers: dict[str, str] | None = None) -> UResponse:
    return _new(content, status=status, content_type="text/plain; charset=utf-8", headers=headers)


def html(content: str, status: int = 200, headers: dict[str, str] | None = None) -> UResponse:
    return _new(content, status=status, content_type="text/html; charset=utf-8", headers=headers)


def json(
    data: Any, status: int = 200, headers: dict[str, str] | None = None, encoder: Any = None
) -> UResponse:
    ...
    return UResponse(
        body=body, status=status, headers=headers, content_type="application/json; charset=utf-8"
    )
...
def error(status: int, message: str | None = None) -> UResponse:
    ...
    return UResponse(body=body, status=status, content_type="text/plain; charset=utf-8")
...
def render(
    ...
    return _new(body, status=status, content_type="text/html; charset=utf-8", headers=headers)
