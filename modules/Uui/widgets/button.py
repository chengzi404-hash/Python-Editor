...
class UButton(tk.Frame):
    def __init__(self, parent, text: str = '', command=None, variant: str = 'default',
                 width: int = 96, height: int = 28, radius: int = 6,
                 font=None, state: str = 'normal', **kwargs):
        ...
        self._rect = _round_rect(self._canvas, 0, 0, width, height, radius,
                                  fill=self._normal, outline='')
        self._text = self._canvas.create_text(
            width // 2, height // 2, text=text, fill=self._fg,
