...
class HighlightThemeMarketplace:
    def __init__(self):
...
_marketplace: HighlightThemeMarketplace = HighlightThemeMarketplace()


def get_marketplace() -> HighlightThemeMarketplace:
    return _marketplace


__all__ = [
    "HighlightThemeMarketplace",
    "HighlightThemePackage",
    "MarketplaceItem",
    "MarketplaceProvider",
    "MarketplaceSearchResult",
    "get_marketplace",
