...
class URequest:
    ...
    def query_string(self) -> str:
        return self._environ.get("QUERY_STRING", "") or ""
    ...
    @property
    def host(self) -> str:
        return self._environ.get("HTTP_HOST", self._environ.get("SERVER_NAME", "")) or ""

    @property
    def content_type(self) -> str:
        return self._environ.get("CONTENT_TYPE", "") or ""
    ...
    def remote_addr(self) -> str:
        return self._environ.get("REMOTE_ADDR", "") or ""
...
def _parse_multipart(
    ...
    try:
        fields = parse_multipart(
            environ, {"CONTENT_LENGTH": str(len(body)), "CONTENT_TYPE": content_type}
        )
